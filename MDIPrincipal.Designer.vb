...
Partial Class MDIPrincipal
    ...
    Private Sub InitializeComponent()
        ...
        PanelCursosElementos = New Panel()
        ...
        PanelCursosElementos.SuspendLayout()
        ...
        PanelLateral.Controls.Add(PanelCursosElementos)
        ...
        btnConsultas.Location = New Point(0, 431)
        ...
        btnInventario.Location = New Point(0, 351)
        ...
        ' 
        ' PanelCursosElementos
        ' 
        PanelCursosElementos.Controls.Add(btnElementos)
        PanelCursosElementos.Dock = DockStyle.Top
        PanelCursosElementos.Location = New Point(0, 323)
        PanelCursosElementos.Name = "PanelCursosElementos"
        PanelCursosElementos.Size = New Size(191, 28)
        PanelCursosElementos.TabIndex = 6
        PanelCursosElementos.TabStop = True
        ' 
        ' btnElementos
        ' 
        btnElementos.BackColor = Color.FromArgb(CByte(35), CByte(32), CByte(39))
        btnElementos.Dock = DockStyle.Top
        btnElementos.FlatAppearance.BorderSize = 0
        btnElementos.FlatStyle = FlatStyle.Flat
        btnElementos.Font = New Font("Segoe UI", 9.75F, FontStyle.Bold)
        btnElementos.ForeColor = SystemColors.Control
        btnElementos.Location = New Point(0, 0)
        btnElementos.Name = "btnElementos"
        btnElementos.Padding = New Padding(30, 0, 0, 0)
        btnElementos.Size = New Size(191, 28)
        btnElementos.TabIndex = 1
        btnElementos.Text = "Elementos"
        btnElementos.TextAlign = ContentAlignment.MiddleLeft
        ...
        btnCursos.Location = New Point(0, 283)
        ...
        PanelMembresias.Size = New Size(191, 31)
        ...
        PanelCursosElementos.ResumeLayout(False)
    ...
    Friend WithEvents PanelCursosElementos As Panel
